...
カウンセラーへの支払いに対して複雑な仕様としては2点あります。  

1点目はカウンセリング中にカウンセラーを変更できるため、必ずしもユーザの支払い(Charge)とカウンセラーへの支払いが1:1になるわけではありません。  
1つのカウンセリングにカウンセラーが複数対応した場合の支払額については、 カウンセリングの対応した日数によって、日割り計算をして割り振ります。

2点目は、カウンセラーが報酬を振り込む際、 Unlaceの仕様で入金時の額に応じて手数料が変わるため、ユーザの支払いに対して、いくら入金できるのかは、口座に振り込む時に確定します。
