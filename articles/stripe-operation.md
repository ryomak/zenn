...
僕自身、0->1を経験するのはUnlaceが初めてだったので、ぶつかった壁が沢山ありました。

その中でも特に苦労したのは、決済基盤です。
経験したことがある領域とはいえ、既に完成されているものと1から作るものでは、全く異なるものでした。

決済基盤についての学びについて記事を書くにあたり、書きたい内容が多かったので、前半と後半に分けようと思います。
前半は、UnlaceにおけるStripeの導入、後半は決済の設計の中で一番苦労した、分析観点でのデータベース設計と実際の分析内容について、書いていこうと思います。
...
一通り大まかな設計から実装を説明しましたが、ここから実際運用する中でぶつかった壁をご紹介します。
